import { TILE_TYPES } from "./assets.js?v=20260307clean";
...
function buildVillage() {
  ...
  return {
    ...
    props: [
      prop("houseA", 2, 16, 6, 7),
      prop("houseB", 10, 16, 6, 7),
      prop("towerA", 20, 13, 4, 8),
      prop("roundTree", 4, 8, 4, 6),
      prop("roundTree", 12, 8, 4, 6),
      prop("palmTree", 37, 7, 4, 7),
      prop("smithy", 33, 14, 7, 6),
      prop("workshop", 42, 14, 7, 6),
...
function buildForest() {
  ...
  return {
    ...
    props: [
      prop("roundTree", 3, 9, 4, 7),
      prop("pineTree", 9, 11, 3, 6),
      prop("firTree", 28, 5, 4, 7),
      prop("hillTree", 34, 5, 4, 7),
...
function buildKeep() {
  ...
  return {
    ...
    props: [
      prop("towerA", 5, 7, 5, 8),
      prop("towerB", 18, 7, 5, 8),
      prop("smithy", 26, 14, 7, 6),
      prop("workshop", 33, 14, 7, 6),
      prop("towerA", 44, 7, 5, 8),
      prop("towerB", 51, 12, 4, 8),
